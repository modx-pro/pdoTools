...
$_lang['pdotools_prop_top'] = 'Выборает родителя указанного "&id" на уровне "&top".';
...
$_lang['pdotools_prop_plPrefix'] = 'Префикс для выставляемых плейсхолдеров, по умолчанию пуст.';
...
$_lang['pdotools_prop_levelClass'] = 'Класс уровня меню. Например, если укажите "level", то будет "level1", "leve2" и т.д.';
...
$_lang['pdotools_prop_tplCategoryFolder'] = 'Специальный чанк оформления категории. Категория - это документ с isfolder = 1 и или нулевым шаблоном, или с атрибутом "rel=category".';
...
$_lang['pdotools_prop_tplParentRowActive'] = 'Чанк оформления активной категории.';
$_lang['pdotools_prop_tplParentRowHere'] = 'Чанк оформления текущей категории.';
