...
$_lang['pdotools_prop_select'] = 'Список полей ресурса для выборки, через запятую. Можно указывать JSON строку с массивом, например {"modResource":"id,pagetitle,content"}.';
