...
$_lang['pdotools_prop_top'] = 'Вместо указанного "&id" будет использован его родитель на уровне "&top". Просмотр идёт от ресурса "&id" вверх, к корню контекста.';
$_lang['pdotools_prop_topLevel'] = 'Вместо указанного "&id" будет использован его родитель на уровне "&topLevel". Просмотр идёт от корня вниз, к ресурсу "&id".';
